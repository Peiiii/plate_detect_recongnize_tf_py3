...
def decode(name, conv_output, num_classes, stride):
    ...
    with tf.variable_scope(name):
        ...
        # print(conv_output)
        # print([batch_size, output_size, output_size, gt_per_grid, 5 + num_classes])
        conv_output = tf.reshape(conv_output, [batch_size, output_size, output_size, gt_per_grid, 5 + num_classes])
        # conv_output = tf.reshape(conv_output, [-1,-1,-1,-1, 5 + num_classes])
        # print(conv_output)
        # input('...')
        ...
        # print(batch_size,gt_per_grid)

        # -------------------------------------------------------------------------------------------------------------------------------------
        # -------------------------------------------------------------------------------------------------------------------------------------

        xy_grid = tf.tile(xy_grid[tf.newaxis, :, :, tf.newaxis, :], [batch_size, 1, 1, gt_per_grid, 1])
        # xy_grid = tf.tile(xy_grid[tf.newaxis, :, :, tf.newaxis, :], [-1, 1, 1, -1, 1])
